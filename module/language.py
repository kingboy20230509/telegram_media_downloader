...
translations = {
    ...
    "Completed": ["完成", "Завершено", "Завершено"],
    "Waiting": ["未下载", "Ожидание", "Очікування"],
    "Active downloads": ["下载中", "Активные загрузки", "Активні завантаження"],
    "Total speed": ["总速度", "Общая скорость", "Загальна швидкість"],
    "Worker count": ["分片数", "Количество потоков", "Кількість потоків"],
    "Worker speeds": ["分片速度", "Скорость потоков", "Швидкість потоків"],
    "Shard": ["分片", "Часть", "Частина"],
    "Expected": ["应有", "Ожидалось", "Очікувалося"],
    "Global worker limit": [
        "总分片并发上限",
        "Общий лимит потоков",
        "Загальний ліміт потоків",
    ],
    "Possible cause": ["可能原因", "Возможная причина", "Можлива причина"],
    "Shard download ended early": [
        "分片下载提前中断",
        "Загрузка части завершилась досрочно",
        "Завантаження частини завершилося достроково",
    ],
    "Telegram connection was reset or shard concurrency may be too high": [
        "Telegram连接被重置或分片并发可能过高",
        "Соединение Telegram сброшено или слишком много параллельных частей",
        "З'єднання Telegram скинуто або забагато паралельних частин",
    ],
