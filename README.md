...
- **single_file_download_workers** - Concurrent ordered range requests for each file, default `2`. Use `2` for standard accounts and try `4` for Premium accounts. This value is also bounded by `max_concurrent_transmissions`.
